...
import 'package:food_app_flutter_zone/src/pages/orders_page.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  void initState() {
    ...
    // profilePage = ProfilePage();
    ordersPage = OrdersPage(model: widget.model);
    pages = [homePage, favoritePage, orderPage,ordersPage];
